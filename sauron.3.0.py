...
#
#
#def FitSingleLevel(_level_scheme,_level_directory,_called_directly=0):
#    '''
#
...
#
#
#def FitBindingLevel(_level_scheme,_called_directly=0):
#    '''
#
...
if __name__ == '__main__':
    ...
    print(FitSinglePeak(level_scheme,'1157.0208',1126.078,1157.004))
