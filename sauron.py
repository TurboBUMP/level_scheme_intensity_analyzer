...
spectra_directory = os.getcwd() + "/spectra/"
    ...
    for file in sorted(os.listdir(spectra_directory)):
        ...
        if filename.endswith(".dat"):
            ...
            for index, gammaray in subsetLevelScheme.iterrows():
                ...
                rFit, I = FitGauss(h, h[0][1] ,gammaray['Egamma-LITERATURE'], 2, h[int(gammaray['Egamma-LITERATURE'])][1], window=6, plot_title=file.replace(".dat","") + " " + str(gammaray['Egamma-LITERATURE']))
