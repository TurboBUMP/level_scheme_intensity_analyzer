...
#     the variable 'I' (difference between the sum of the bin contents and the integral of the fitted funtion).
#     'I' is useful to evaluate the goodness of the fit.
...
if isdir(join(os.getcwd(),args.pos_arg)):
        ...
        for file in sorted(os.listdir(spectra_directory)):
            ...
            if filename.endswith(".dat"):
                ...
                for index, gammaray in subsetLevelScheme.iterrows():
                    ...
                    print(int(I), ",", gammaray['Egamma-LITERATURE'], ",", file.replace('.dat',''), ",", rFit[0],",",rFit[1],",",rFit[2],",",rFit[3],",",rFit[4],file=f)

else:
    print('Error: ' + args.pos_arg + ' is not a directory. Skipping it')
    pass
